...
fn wire__crate__multimint__Multimint_subscribe_lightning_events_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
...
impl SseDecode for crate::multimint::DepositEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                ...
                return crate::multimint::DepositEvent::Mempool(var_field0);
            }
            1 => {
                let mut var_field0 =
                    <crate::multimint::AwaitingConfsEvent>::sse_decode(deserializer);
                return crate::multimint::DepositEvent::AwaitingConfs(var_field0);
            }
            2 => {
                let mut var_field0 = <crate::multimint::ConfirmedEvent>::sse_decode(deserializer);
                return crate::multimint::DepositEvent::Confirmed(var_field0);
            }
            3 => {
                let mut var_field0 = <crate::multimint::ClaimedEvent>::sse_decode(deserializer);
                return crate::multimint::DepositEvent::Claimed(var_field0);
            }
            _ => {
                unimplemented!("");
            }
...
impl SseDecode for crate::multimint::LightningEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut tag_ = <i32>::sse_decode(deserializer);
        match tag_ {
            0 => {
                ...
                return crate::multimint::LightningEvent::InvoicePaid(var_field0);
            }
            _ => {
                unimplemented!("");
            }
...
impl SseDecode for crate::multimint::MultimintEventKind {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                let mut var_field0 = <crate::multimint::DepositEvent>::sse_decode(deserializer);
                return crate::multimint::MultimintEventKind::Deposit(var_field0);
            }
            1 => {
                let mut var_field0 = <crate::multimint::LightningEvent>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        47 => wire__crate__multimint__Multimint_subscribe_lightning_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::multimint::DepositEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::multimint::DepositEvent::Mempool(field0) => {
                [0.into_dart(), field0.into_into_dart().into_dart()].into_dart()
            }
            crate::multimint::DepositEvent::AwaitingConfs(field0) => {
                [1.into_dart(), field0.into_into_dart().into_dart()].into_dart()
            }
            crate::multimint::DepositEvent::Confirmed(field0) => {
                [2.into_dart(), field0.into_into_dart().into_dart()].into_dart()
            }
            crate::multimint::DepositEvent::Claimed(field0) => {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::multimint::DepositEvent
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::multimint::DepositEvent>
    for crate::multimint::DepositEvent
{
    fn into_into_dart(self) -> crate::multimint::DepositEvent {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::multimint::LightningEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::multimint::LightningEvent::InvoicePaid(field0) => {
                [0.into_dart(), field0.into_into_dart().into_dart()].into_dart()
            }
            _ => {
                unimplemented!("");
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::multimint::LightningEvent
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::multimint::LightningEvent>
    for crate::multimint::LightningEvent
{
    fn into_into_dart(self) -> crate::multimint::LightningEvent {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::multimint::DepositEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::multimint::DepositEvent::Mempool(field0) => {
...
impl SseEncode for crate::multimint::LightningEvent {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::multimint::LightningEvent::InvoicePaid(field0) => {
...
impl SseEncode for crate::multimint::MultimintEventKind {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::multimint::MultimintEventKind::Deposit(field0) => {
                <i32>::sse_encode(0, serializer);
                <crate::multimint::DepositEvent>::sse_encode(field0, serializer);
            }
            crate::multimint::MultimintEventKind::Lightning(field0) => {
                <i32>::sse_encode(1, serializer);
                <crate::multimint::LightningEvent>::sse_encode(field0, serializer);
            }
            _ => {
                unimplemented!("");
            }
